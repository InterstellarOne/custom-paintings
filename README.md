...
This painting only includes one template, with a different format to the rest. Copy the top left painting tile to the left square, and the top right painting tile to the right square.
...
3. Go to https://minecraft.tools/en/skin.php?skin=YOUR-USERNAME, replacing the last part with your username. Leave this browser tab open.
...
8. Go your tab with minecraft.tools, which you would have opened in step 3. Reload the page, then copy everything inside of the quotation marks next to the **value** field under _/give command to get his/her head with a fixed skin (1.13+)_.
...
There's four templates for this one. The first template is for the top layer, the second one is the bottom layer, the third is the outside edges, and the fourth is the middle four. Pay close attention to the location of each square and make sure to flip the indicated tile horizontally.
